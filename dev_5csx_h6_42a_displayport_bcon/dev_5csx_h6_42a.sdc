...
create_clock -period "84 MHz" [get_ports HSMC1_RX15]
create_clock -period "84 MHz" [get_ports HSMC1_RX14]
...
set_false_path -from {dev_5csx_h6_42a:u0|bcon_input:bcon_input_0|s_srst_reg} -to *
set_false_path -from {dev_5csx_h6_42a:u0|bcon_input:bcon_input_0|s_pll_rst_reg} -to *
set_false_path -from * -to {dev_5csx_h6_42a:u0|bcon_input:bcon_input_0|s_fifo_data_full_reg}
