...
# ACDS 16.0 222 linux 2017.01.17.19:16:37
# ----------------------------------------
...
# ----------------------------------------
# If cv_video_pll is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "cv_video_pll"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/cv_video_pll.vo"
}
